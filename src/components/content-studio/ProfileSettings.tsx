...
export function ProfileSettings({ canManage = true }: ProfileSettingsProps) {
  ...
  const handleSave = async () => {
    ...
    toast({
      title: "Kaydedildi",
      description: "Profil ayarları başarıyla güncellendi.",
    });
  };
  ...
  const handleInstagramConnect = async () => {
    ...
    toast({
      ...
      description: "Hesabınız başarıyla eşleştirildi.",
    });
  };
  ...
  const handleInstagramDisconnect = () => {
    ...
    toast({
      ...
      description: "Instagram hesabı kaldırıldı.",
    });
  };
