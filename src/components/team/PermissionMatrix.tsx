import { Users, Dumbbell, Apple, DollarSign, Shield, ShoppingBag, Palette, Mail, FileCode2 } from 'lucide-react';
...
const MODULES: ModuleConfig[] = [
  {
    ...
    fields: [
      ...
      { key: 'scopeOwnOnly', label: 'Sadece kendi sporcularını görsün' },
    ],
  },
  {
    key: 'templates',
