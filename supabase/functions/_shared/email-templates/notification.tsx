    ...
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          {recipientName && <Text style={greeting}>Merhaba {recipientName},</Text>}
...
const greeting = { fontSize: '14px', color: '#f8f8f8', margin: '0 0 12px' }
const text = { fontSize: '15px', color: '#a3a3a3', lineHeight: '1.7', margin: '0 0 24px', whiteSpace: 'pre-wrap' as const }
