...
export const InviteEmail = ({ siteName, siteUrl, confirmationUrl }: InviteEmailProps) => (
  <Html lang="tr" dir="ltr">
    <Head />
    <Preview>{siteName}'e davet edildiniz</Preview>
    <Body style={main}>
      <Container style={container}>
        ...
        <Section style={card}>
          ...
          <Text style={text}>
            <Link href={siteUrl} style={link}><strong style={{ color: '#f2f2f2' }}>{siteName}</strong></Link> ekibine katılmaya davet edildiniz. Hesabınızı oluşturmak için aşağıdaki butona tıklayın.
          </Text>
          <Section style={buttonWrap}>
            <Button style={button} href={confirmationUrl}>Daveti Kabul Et</Button>
          </Section>
          <Text style={small}>
          ...
          <Hr style={hr} />
          <Text style={footer}>
            Bu daveti beklemiyorsanız bu maili görmezden gelebilirsiniz.
          </Text>
        </Section>
      </Container>
    </Body>
