...
DECLARE
  ...
  paid_statuses           TEXT[]  := ARRAY['paid','shipped','completed','delivered'];
BEGIN
  ...
  coaching_total := pkg_payments_revenue + coaching_orders_revenue + custom_paid_revenue;
  ...
  RETURN json_build_object(
    ...
    'total_store_revenue',    shopify_revenue + digital_revenue,
    'paid_custom_revenue',    custom_paid_revenue,
    'pending_custom_revenue', pending_custom_revenue,
    'total_revenue',          coaching_total + shopify_revenue + digital_revenue,
